...
(10007, 8, NULL, 'Isabela Almeida', FALSE, '2025-02-11', 'Roberto Almeida', 'Lactose'),
...
(10000, '2025-11-01', 'good', 'Muito bom o almoço!'),
(10001, '2025-11-01', 'mid', 'Estava razoável.'),
(10002, '2025-11-02', 'bad', 'Comida fria e sem gosto.'),
(10003, '2025-11-02', 'good', 'Gostei da salada.'),
(10004, '2025-11-03', 'good', 'Excelente refeição hoje.'),
(10005, '2025-11-03', 'bad', 'Não gostei do tempero.'),
(10006, '2025-11-04', 'mid', 'Poderia ser melhor.'),
(10007, '2025-11-04', 'good', 'Delicioso e bem servido.'),
(10008, '2025-11-05', 'bad', 'Pouca quantidade.'),
(10009, '2025-11-05', 'mid', 'Estava ok.'),
(10010, '2025-11-05', 'mid', 'Estava ok.'),

(10011, '2025-11-01', 'good', 'Muito bom o almoço!'),
(10012, '2025-11-01', 'mid', 'Estava razoável.'),
(10013, '2025-11-02', 'bad', 'Comida fria e sem gosto.'),
(10014, '2025-11-02', 'good', 'Gostei da salada.'),
(10015, '2025-11-03', 'good', 'Excelente refeição hoje.'),
(10016, '2025-11-03', 'bad', 'Não gostei do tempero.'),
(10017, '2025-11-04', 'mid', 'Poderia ser melhor.'),
(10018, '2025-11-04', 'good', 'Delicioso e bem servido.'),
(10019, '2025-11-05', 'bad', 'Pouca quantidade.'),
(10020, '2025-11-05', 'mid', 'Estava ok.'),

(10021, '2025-11-01', 'good', 'Muito bom o almoço!'),
(10022, '2025-11-01', 'mid', 'Estava razoável.'),
(10023, '2025-11-02', 'bad', 'Comida fria e sem gosto.'),
(10024, '2025-11-02', 'good', 'Gostei da salada.'),
(10025, '2025-11-03', 'good', 'Excelente refeição hoje.'),
(10026, '2025-11-03', 'bad', 'Não gostei do tempero.'),
(10027, '2025-11-04', 'mid', 'Poderia ser melhor.'),
(10028, '2025-11-04', 'good', 'Delicioso e bem servido.'),
(10029, '2025-11-05', 'bad', 'Pouca quantidade.'),
(10030, '2025-11-05', 'mid', 'Estava ok.'),

(10031, '2025-11-01', 'good', 'Muito bom o almoço!'),
(10032, '2025-11-01', 'mid', 'Estava razoável.'),
(10033, '2025-11-02', 'bad', 'Comida fria e sem gosto.'),
(10034, '2025-11-02', 'good', 'Gostei da salada.'),
(10035, '2025-11-03', 'good', 'Excelente refeição hoje.'),
(10036, '2025-11-03', 'bad', 'Não gostei do tempero.'),
(10037, '2025-11-04', 'mid', 'Poderia ser melhor.'),
(10038, '2025-11-04', 'good', 'Delicioso e bem servido.'),
(10039, '2025-11-05', 'bad', 'Pouca quantidade.'),
(10040, '2025-11-05', 'mid', 'Estava ok.'),

(10041, '2025-11-01', 'good', 'Muito bom o almoço!'),
(10042, '2025-11-01', 'mid', 'Estava razoável.'),
(10043, '2025-11-02', 'bad', 'Comida fria e sem gosto.'),
(10044, '2025-11-02', 'good', 'Gostei da salada.'),
(10045, '2025-11-03', 'good', 'Excelente refeição hoje.'),
(10046, '2025-11-03', 'bad', 'Não gostei do tempero.'),
(10047, '2025-11-04', 'mid', 'Poderia ser melhor.'),
(10048, '2025-11-04', 'good', 'Delicioso e bem servido.'),
(10049, '2025-11-05', 'bad', 'Pouca quantidade.');
...
(4, 10.000, '2025-07-25', '2025-11-30', 'L04D56', 'Setor de carnes'),
(5, 30.100, '2025-07-26', '2025-09-10', 'L05E67', 'Cozinha principal'),
(6, 8.000, '2025-07-27', '2025-11-15', 'L06F78', 'Hortifruti'),
(7, 12.400, '2025-07-28', '2025-11-18', 'L07G89', 'Hortifruti'),
...
(1,  '2025-11-01', 'Pão de Queijo', 20.000, 'breakfast', 'morning', 20.000, 'Produção inicial para o café da manhã'),
(2,  '2025-11-01', 'Arroz com Feijão', 30.000, 'lunch', 'morning', 50.000, 'Produção para o almoço completo'),
(3,  '2025-11-01', 'Bolo de Chocolate', 15.000, 'snack', 'morning', 30.000, 'Lanche para a tarde'),
(4,  '2025-11-01', 'Frango Assado', 25.000, 'dinner', 'evening', 10.000, 'Refeição principal do jantar'),
(5,  '2025-11-01', 'Mingau de Aveia', 10.000, 'breakfast', 'morning', 5.000, 'Opção saudável para café'),
(6,  '2025-11-01', 'Pão de Queijo', 18.000, 'breakfast', 'morning', 25.000, 'Produção para café da manhã, extra'),
(7,  '2025-11-01', 'Arroz à Grega', 25.000, 'lunch', 'night', 40.000, 'Almoço com opções de acompanhamento'),
(8,  '2025-11-01', 'Lasanha de Carne', 22.000, 'dinner', 'evening', 15.000, 'Jantar com prato quente e reforçado'),
(9,  '2025-11-02', 'Salada de Frutas', 11.000, 'snack', 'morning', 12.000, 'Lanche saudável para a manhã'),
(10,  '2025-11-02', 'Sopa de Legumes', 12.000, 'dinner', 'night', 18.000, 'Sopa leve para a noite');
...
(10000, '2025-11-23 07:30:00', 'Problema de saúde', 'breakfast', 'temporary', 'no'),
(10001, '2025-11-23 12:00:00', 'Viajei para outro estado', 'lunch', 'temporary', 'yes'),
(10002, '2025-11-24 15:00:00', 'Compromisso acadêmico', 'snack', 'permanent', 'no'),
(10003, '2025-11-24 19:30:00', 'Feriado prolongado', 'dinner', 'temporary', 'yes'),
(10004, '2025-11-25 07:00:00', 'Reunião fora da cidade', 'breakfast', 'temporary', 'no'),
(10005, '2025-11-25 12:30:00', 'Visita de familiares', 'lunch', 'temporary', 'no'),
(10006, '2025-11-26 16:00:00', 'Curso de atualização profissional', 'snack', 'permanent', 'yes'),
(10007, '2025-11-26 20:00:00', 'Viagem internacional', 'dinner', 'temporary', 'no'),
(10008, '2025-11-27 08:00:00', 'Atraso devido ao trânsito', 'breakfast', 'temporary', 'yes'),
(10009, '2025-11-27 13:00:00', 'Evento corporativo', 'lunch', 'permanent', 'no');
