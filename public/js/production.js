...
async function loadProducts() {
  try {
    const response = await fetch(`https://smart-meal-backend.vercel.app/product`);
...
async function loadProduction(date) {
  try {
    ...
    const response = await fetch(`https://smart-meal-backend.vercel.app/production${query}`);
...
form.addEventListener("submit", async (e) => {
  ...
  try {
    const response = await fetch(`https://smart-meal-backend.vercel.app/production`, {
      method: "POST",
