...
async function loadFeedbacks() {
  try {
    const response = await fetch(`https://smart-meal-backend.vercel.app/feedback/getAllFeedbacks`);
...
async function submitFeedback(e) {
  ...
  try {
    const response = await fetch(`https://smart-meal-backend.vercel.app/feedback/submitFeedback`, {
      method: "POST",
